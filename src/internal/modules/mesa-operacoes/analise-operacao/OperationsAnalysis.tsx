  ...
  return (
    <div className="oa-container">
            ...
            <div className="oa-modal-body" style={{ padding: '20px' }}>
              {diagnoseLoading ? (
                ...
                <div className="oa-empty-card">
                  <p>Nenhum dado retornado para esta operação.</p>
                </div>
              )}
            </div>
      ...
      {cnabModalOpen && operationDetail && (
        <div className="oa-modal-overlay oa-cnab-modal-overlay" style={{ zIndex: 10050 }} onClick={() => setCnabModalOpen(false)}>
                  ...
                  <div className="oa-cnab-models-grid">
                    ...
                    >
                      ...
                      <div className="oa-cnab-model-details">
                        ...
                        <div className="oa-model-detail-row">
                          <span>Layout:</span>
                          <strong>CNAB 400 posições</strong>
                        </div>
                      </div>
                    </div>
